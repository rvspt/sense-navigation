...
define([
  ...
  var actionBefore3 = {
	...
	defaultValue: "none",
	show: function ( data ) {
		return data.props.isActionsBefore && data.props.actionBefore2 !== 'none';
	},
	options: actionOptions
  };
  var actionBefore4 = {
	...
	defaultValue: "none",
	show: function ( data ) {
		return data.props.isActionsBefore && data.props.actionBefore2 && data.props.actionBefore3 !== 'none';
	},
	options: actionOptions
  };
  var actionBefore5 = {
	...
	defaultValue: "none",
	show: function ( data ) {
		return data.props.isActionsBefore && data.props.actionBefore2 && data.props.actionBefore3 && data.props.actionBefore4 !== 'none';
	},
	options: actionOptions
  };
